-- =============================================================
-- Toasty OS — Menu: Categories + Products
-- Migration: 20260817090001_menu_categories_products.sql
-- =============================================================
...
create table if not exists public.menu_categories (
  ...
  constraint uq_menu_categories_org_id unique (organization_id, id),
...
-- Cross-tenant composite FK: category must belong to same org
alter table public.products
  add constraint fk_products_category_tenant
  foreign key (category_id, organization_id)
  references public.menu_categories(id, organization_id)
  on delete set null;

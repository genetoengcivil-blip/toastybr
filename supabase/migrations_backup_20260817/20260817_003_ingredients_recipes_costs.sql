...
-- Migration: 20260817_003_ingredients_recipes_costs.sql
-- =============================================================
...
-- Cross-tenant protection: product must belong to same organization
alter table public.product_recipe_items
  add constraint chk_recipe_items_product_org
  check (
    exists (
